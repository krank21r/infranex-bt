...
> = {
  ...
  gpus: { title: "GPU Catalog", eyebrow: "Section · 05 · Infrastructure" },
  miners: { title: "My Miners", eyebrow: "Section · 08 · Portfolio" },
  deployments: { title: "Deployments", eyebrow: "Section · 06 · Deployment engine" },
  devops: { title: "DevOps Engine", eyebrow: "Section · 07 · Live operations" },
  monitoring: { title: "Monitoring", eyebrow: "Section · 09 · Monitoring engine" },
